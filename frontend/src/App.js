  ...
  return (
    <div className="space-y-6" data-testid="sms-parser">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-600">Parse SMS messages for <span className="font-semibold text-blue-600">{getSelectedDateDisplay()}</span></p>
      </div>
  ...
  return (
    <div className="max-w-md mx-auto space-y-6" data-testid="manual-entry">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-600">Adding transaction for <span className="font-semibold text-blue-600">{getSelectedDateDisplay()}</span></p>
      </div>
